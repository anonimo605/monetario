...
import { ArrowLeft, Settings, ChevronsRight, Megaphone, LifeBuoy, Satellite, Users, Gift, Award, LogOut, Briefcase, Banknote, ShieldCheck, Coins } from 'lucide-react';
        ...
        <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Button className="w-full justify-between" variant="secondary" onClick={() => router.push('/superadmin/satellites')}>
                    <div className='flex items-center'><Coins className="mr-2 h-4 w-4" />Gestión de Monedas</div>
                    <ChevronsRight className="ml-auto h-4 w-4"/>
                </Button>
