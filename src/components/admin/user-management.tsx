...
const UserManagement = () => {
    ...
    const handleViewSatellites = async (user: User) => {
        try {
            ...
            toast({ variant: "destructive", title: "Error", description: "No se pudieron cargar las monedas del usuario." });
        }
    };
    ...
    const handleDeleteSatellite = async (userId: string, satelliteId: string) => {
        ...
        try {
            ...
            toast({ title: "Moneda Eliminada del Usuario" });
        } catch (error) {
            console.error("Error deleting user satellite: ", error);
            toast({ variant: "destructive", title: "Error", description: "No se pudo eliminar la moneda del usuario." });
        }
    };
        ...
        <>
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                Esta acción no se puede deshacer. Esto eliminará permanentemente al usuario y toda su información. La subcolección de monedas deberá ser eliminada manualmente o con una Cloud Function.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
            ...
            <Dialog open={!!viewingUser} onOpenChange={(isOpen) => !isOpen && setViewingUser(null)}>
                <DialogContent className="sm:max-w-2xl">
                    <DialogHeader>
                        <DialogTitle>Monedas de {viewingUser?.phoneNumber}</DialogTitle>
                        <DialogDescription>
                            Aquí puedes ver y eliminar las monedas que ha comprado este usuario.
                        </DialogDescription>
                    </DialogHeader>
                                ...
                                {viewingUser?.purchasedSatellites && viewingUser.purchasedSatellites.length > 0 ? (
                                        ...
                                        <TableRow key={satellite.id}>
                                            ...
                                            <TableCell className="text-right">
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            <AlertDialogTitle>¿Eliminar moneda del usuario?</AlertDialogTitle>
                                                            <AlertDialogDescription>
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={4} className="text-center text-muted-foreground py-8">
                                            Este usuario no tiene monedas compradas.
                                        </TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
