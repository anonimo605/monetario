...
const WithdrawalSection = () => {
    ...
    const hasPurchasedSatellites = purchasedSatellites.length > 0;
    ...
    const canWithdraw = user?.withdrawalInfo && hasPurchasedSatellites && isWithinWithdrawalWindow && !hasReachedDailyLimit && isAllowedDay;
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                     <Alert variant={hasPurchasedSatellites ? "default" : "destructive"} className="border-l-4">
                        {hasPurchasedSatellites ? <ShoppingCart className="h-4 w-4" /> : <ShoppingCart className="h-4 w-4" />}
                        <AlertTitle>{hasPurchasedSatellites ? "Requisito cumplido" : "Requisito pendiente"}</AlertTitle>
                        <AlertDescription>
                            {hasPurchasedSatellites ? "Ya has comprado productos." : "Debes comprar al menos una moneda para retirar."}
                        </AlertDescription>
                    </Alert>
